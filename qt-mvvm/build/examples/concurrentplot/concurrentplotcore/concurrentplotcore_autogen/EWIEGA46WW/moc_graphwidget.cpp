...
#include <memory>
#include "../../../../../../examples/concurrentplot/concurrentplotcore/graphwidget.h"
...
QT_MOC_LITERAL(1, 12, 21), // "onSimulationCompleted"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "GraphWidget\0onSimulationCompleted\0"
};
...
void GraphWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onSimulationCompleted(); break;
        default: ;
        }
    }
    (void)_a;
