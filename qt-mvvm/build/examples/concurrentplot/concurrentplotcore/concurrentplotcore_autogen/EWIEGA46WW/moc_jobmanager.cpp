...
#include <memory>
#include "../../../../../../examples/concurrentplot/concurrentplotcore/jobmanager.h"
...
QT_MOC_LITERAL(4, 34, 19), // "simulationCompleted"
QT_MOC_LITERAL(5, 54, 17), // "requestSimulation"
QT_MOC_LITERAL(6, 72, 8), // "setDelay"
QT_MOC_LITERAL(7, 81, 18) // "onInterruptRequest"

    },
    "JobManager\0progressChanged\0\0value\0"
    "simulationCompleted\0requestSimulation\0"
    "setDelay\0onInterruptRequest"
};
...
void JobManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->simulationCompleted(); break;
        case 2: _t->requestSimulation((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 3: _t->setDelay((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->onInterruptRequest(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&JobManager::progressChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&JobManager::simulationCompleted)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void JobManager::progressChanged(int _t1)
{
...
// SIGNAL 1
void JobManager::simulationCompleted()
{
