...
#include <memory>
#include "../../../../../source/libmvvm_viewmodel/mvvm/editors/customeventfilters.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ModelView__LostFocusFilter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ModelView__LostFocusFilter_t qt_meta_stringdata_ModelView__LostFocusFilter = {
    {
QT_MOC_LITERAL(0, 0, 26) // "ModelView::LostFocusFilter"
...
QT_INIT_METAOBJECT const QMetaObject ModelView::LostFocusFilter::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ModelView__LostFocusFilter.data,
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ModelView__WheelEventFilter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ModelView__WheelEventFilter_t qt_meta_stringdata_ModelView__WheelEventFilter = {
    {
QT_MOC_LITERAL(0, 0, 27) // "ModelView::WheelEventFilter"
...
QT_INIT_METAOBJECT const QMetaObject ModelView::WheelEventFilter::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ModelView__WheelEventFilter.data,
