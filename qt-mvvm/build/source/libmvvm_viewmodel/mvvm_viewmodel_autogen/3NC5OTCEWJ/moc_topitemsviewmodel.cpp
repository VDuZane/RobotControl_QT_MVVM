...
#include <memory>
#include "../../../../../source/libmvvm_viewmodel/mvvm/viewmodel/topitemsviewmodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ModelView__TopItemsViewModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ModelView__TopItemsViewModel_t qt_meta_stringdata_ModelView__TopItemsViewModel = {
    {
QT_MOC_LITERAL(0, 0, 28) // "ModelView::TopItemsViewModel"
...
QT_INIT_METAOBJECT const QMetaObject ModelView::TopItemsViewModel::staticMetaObject = { {
    QMetaObject::SuperData::link<ViewModel::staticMetaObject>(),
    qt_meta_stringdata_ModelView__TopItemsViewModel.data,
