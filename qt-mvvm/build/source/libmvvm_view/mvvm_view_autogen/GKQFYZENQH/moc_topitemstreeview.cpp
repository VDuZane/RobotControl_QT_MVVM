...
#include <memory>
#include "../../../../../source/libmvvm_view/mvvm/widgets/topitemstreeview.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ModelView__TopItemsTreeView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ModelView__TopItemsTreeView_t qt_meta_stringdata_ModelView__TopItemsTreeView = {
    {
QT_MOC_LITERAL(0, 0, 27) // "ModelView::TopItemsTreeView"
...
QT_INIT_METAOBJECT const QMetaObject ModelView::TopItemsTreeView::staticMetaObject = { {
    QMetaObject::SuperData::link<ItemsTreeView::staticMetaObject>(),
    qt_meta_stringdata_ModelView__TopItemsTreeView.data,
