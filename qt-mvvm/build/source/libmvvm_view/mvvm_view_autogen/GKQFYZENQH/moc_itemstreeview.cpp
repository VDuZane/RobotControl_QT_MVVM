...
#include <memory>
#include "../../../../../source/libmvvm_view/mvvm/widgets/itemstreeview.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ModelView__ItemsTreeView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ModelView__ItemsTreeView_t qt_meta_stringdata_ModelView__ItemsTreeView = {
    {
QT_MOC_LITERAL(0, 0, 24), // "ModelView::ItemsTreeView"
QT_MOC_LITERAL(1, 25, 12), // "itemSelected"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 23), // "ModelView::SessionItem*"
QT_MOC_LITERAL(4, 63, 18), // "onSelectionChanged"
QT_MOC_LITERAL(5, 82, 14) // "QItemSelection"

    },
    "ModelView::ItemsTreeView\0itemSelected\0"
    "\0ModelView::SessionItem*\0onSelectionChanged\0"
    "QItemSelection"
};
...
void ModelView::ItemsTreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->itemSelected((*reinterpret_cast< ModelView::SessionItem*(*)>(_a[1]))); break;
        case 1: _t->onSelectionChanged((*reinterpret_cast< const QItemSelection(*)>(_a[1])),(*reinterpret_cast< const QItemSelection(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ItemsTreeView::itemSelected)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ModelView::ItemsTreeView::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ModelView__ItemsTreeView.data,
